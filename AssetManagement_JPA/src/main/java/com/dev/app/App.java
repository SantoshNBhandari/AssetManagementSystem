			...
			if (op == 1) {
				...
				if (um != null) {
					if (um.getUsertype().equalsIgnoreCase("manager")) {
						...
						System.out.println("**********************");
						jp: while (true) {
							System.out.println("_--__--__--__ENTER YOUR CHOICE__--__--__--__");
							...
							case 1:
								...
								System.out.println("Raised allocation request :" + s.serviceRaiseReq(asetallocate));
								System.out
								.println("Randomly Generated Allocation Id :" + asetallocate.getAllocationid());
								break;
							case 2:
							...
							case 3:
								...
								if(s.addEmployee(emp))
								System.out.println("Added Employee ID :" +emp.getEmpno());
								break;
							case 5:
							...
							case 6:
								...
								break jump1;
							case 4:
								s.getAllAssetAllocationService();
								break;
							}
					...
					if (um.getUsertype().equalsIgnoreCase("admin")) {
						...
						always: while (true) {
							...
							case 1:
								...
								as.setStatus(status);
								if(s.addAsset(as))
								System.out.println("ASSET ADDED : ASSET ID"+as.getAssetid());
								break;
							case 2:
								...
								if(s.removeAsset(Integer.parseInt(asid))!=null)
										{
									System.out.println("Asset DELETEd:Assetid"+asid);
										}
								else
							...
							case 3:
								...
								case 1:
									...
									if(s.updateAsset(a, asu))
									System.out.println("Asset NAME UPDATED OF ASSET ID:"+a);
									else
										System.out.println("Asset NAME NOT UPDATED OF ASSET ID:"+a);
								...
								case 2:
									...
									if(s.updateAsset(a, asu))
										System.out.println("Asset Description UPDATED OF ASSET ID:"+a);
										else
											System.out.println("Asset Description NOT UPDATED OF ASSET ID:"+a);
									break;
								case 3:
									...
									if(s.updateAsset(a, asu))
										System.out.println("Asset Quantity UPDATED OF ASSET ID:"+a);
										else
											System.out.println("Asset Quantity NOT UPDATED OF ASSET ID:"+a);
									break;
								case 4:
									...
									if(s.updateAsset(a, asu))
										System.out.println("Asset Status UPDATED OF ASSET ID:"+a);
										else
											System.out.println("Asset Status NOT UPDATED OF ASSET ID:"+a);
									break;
								default:
							...
							case 4:
								...
								break;
							case 5:
								List<AssetAllocation>	list=s.getAllAssetAllocationService();
							...
							case 6:
								...
								if(s.setStatusService(allocatioid, stas))
									System.out.println("STATUS CHANGED OF ALLOCATION ID:"+allocatid);
								else
									System.out.println("WRONG ALLOCATION ID");
								break;
							case 7:
